                                ...
                                {supportAgent ? (
                                    <>
                                        <div className="relative">
                                            ...
                                            {(supportAgent as any).settings?.showOnlineStatus !== false && <span className="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full bg-green-500 ring-2 ring-white"></span>}
                                        </div>
                                        <div>
                                            <p className="font-semibold">
                                                {(supportAgent as any).settings?.profileVisibility === 'public' ? (
