                ...
                <CardContent className="flex-1 overflow-y-auto p-4 space-y-6 bg-slate-50">
                    {messages.length === 0 && !chatLoading && (
                        <div className="text-center text-muted-foreground mt-10">
                            <p>{isGroup ? t('assistance.interface.welcomeGroup') : t('assistance.interface.startConversation', { name: displayName })}</p>
                        </div>
                    )}
    ...
    return (
        <div className="space-y-8 p-6 max-w-7xl mx-auto bg-slate-50 min-h-screen">
            ...
            <div className="text-center space-y-2">
                ...
                {/* Option 1: WhatsApp Deep Link (instant contact) */}
                <button
                    onClick={() => window.open("https://wa.me/447397136870?text=" + encodeURIComponent("Hello Hopeline Support, I need assistance."), "_blank", "noopener,noreferrer")}
                    className="inline-flex items-center gap-2 mt-2 px-5 py-2 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white text-sm font-semibold transition-colors shadow-sm"
                >
                ...
                <TabsContent value="call">
                    ...
                    <Card className="h-[calc(100vh-32rem)] flex flex-col items-center justify-center shadow-lg p-6 text-center">
                        <CardHeader>
                            ...
                            <CardDescription>{t('assistance.voiceVideoDesc')}</CardDescription>
                        </CardHeader>
                        <CardContent className="flex flex-col items-center gap-6">
                            ...
                            {!supportAgent && availableAgents.length > 0 && (
                                <p className="text-sm text-muted-foreground">{t('assistance.selectAgentFirst')}</p>
                            )}
                        </CardContent>
                    </Card>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">
                                                        {call.startTime ? new Date(call.startTime).toLocaleString() : t('common.unknownTime')}
                                                    </p>
                                                </div>
                                            </div>
