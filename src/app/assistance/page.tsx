...
export default function AssistancePage() {
    ...
    const startCall = async (type: 'voice' | 'video') => {
        ...
        try {
            ...
            // CallInterface will handle the rest (ringing, joining, etc.)
    ...
    const handleSend = async () => {
        if ((!inputValue.trim() && attachments.length === 0) || !user || (!supportAgent && !chatId) || sending) return;
        setSending(true);
        ...
        <div className="space-y-8 p-6 max-w-7xl mx-auto bg-slate-50 min-h-screen">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="group">
                    {/* Directly render chat interface for group */}
                    {renderChatInterface()}
                </TabsContent>
