...
export function AlertsOverTimeChart({ alerts }: { alerts: SosAlert[] }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t("admin.dashboard.sosAlertsOverTime")}</CardTitle>
        <CardDescription>{t("admin.dashboard.dailyAlertCount")}</CardDescription>
      </CardHeader>
      <CardContent>
...
export function ShelterOccupancyChart({ shelters }: { shelters: Shelter[] }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t("admin.dashboard.shelterOccupancyOverview")}</CardTitle>
        <CardDescription>{t("admin.dashboard.currentOccupancyRates")}</CardDescription>
      </CardHeader>
      <CardContent>
...
export function EmergencyTypesChart({ alerts }: { alerts: SosAlert[] }) {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader>
        <CardTitle>{t("admin.dashboard.emergencyTypes")}</CardTitle>
        <CardDescription>{t("admin.dashboard.alertTypesBreakdown")}</CardDescription>
      </CardHeader>
...
export function DisplacedPersonsStatusChart({ persons }: { persons: DisplacedPerson[] }) {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader>
        <CardTitle>{t("admin.dashboard.displacedPersonsStatus")}</CardTitle>
        <CardDescription>{t("admin.dashboard.currentStatusTracked")}</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 pb-0">
