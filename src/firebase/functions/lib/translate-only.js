...
exports.translateNewMessage = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
/**
 * Translate new chat messages using Google Translate API v2
 */
exports.translateNewMessage = functions
    ...
    try {
        ...
        const senderRole = (senderData === null || senderData === void 0 ? void 0 : senderData.role) || 'user';
        const senderLanguage = ((_a = senderData === null || senderData === void 0 ? void 0 : senderData.settings) === null || _a === void 0 ? void 0 : _a.language) || (senderData === null || senderData === void 0 ? void 0 : senderData.language) || 'en';
        // Get receiver's data
        const receiverDoc = await admin.firestore().collection("users").doc(receiverId).get();
        const receiverData = receiverDoc.data();
        const receiverRole = (receiverData === null || receiverData === void 0 ? void 0 : receiverData.role) || 'user';
        const receiverLanguage = ((_b = receiverData === null || receiverData === void 0 ? void 0 : receiverData.settings) === null || _b === void 0 ? void 0 : _b.language) || (receiverData === null || receiverData === void 0 ? void 0 : receiverData.language) || 'en';
...
//# sourceMappingURL=translate-only.js.map