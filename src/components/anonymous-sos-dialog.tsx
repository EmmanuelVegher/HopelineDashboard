        ...
        (error) => {
          ...
          switch (error.code) {
            ...
            case error.POSITION_UNAVAILABLE:
              errorMessage = "Location information is unavailable. Ensure your device GPS is on and try moving to an open area.";
              break;
            case error.TIMEOUT:
              errorMessage = "Request to get user location timed out. Please try again.";
              break;
          }
